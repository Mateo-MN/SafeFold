...
## Pipeline Overview
The inner workings of the SafeFold are explained in the following document: [Model document](https://drive.google.com/file/d/1zPO5KYLNB37b80zKEq2mDADQtGjVje7M/view?usp=sharing)
